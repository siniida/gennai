...
public final class GungnirConst {
  ...
  public static final String DEBUG_LOGGER_NAME = "gungnir";
  ...
  public static final String GUNGNIR_NODE_PATH = "/gungnir";
  public static final String CLUSTER_NODE_PATH = GUNGNIR_NODE_PATH + "/cluster";
  ...
  public static String getGungnirCoreJarName() {
    return System.getProperty(GUNGNIR_HOME) + "/" + GUNGNIR_CORE_JAR_PREFIX
