...
public final class GungnirConfig extends LinkedHashMap<String, Object> {
  ...
  public static final String KAFKA_MONITOR_BROKERS = "kafka.monitor.brokers";
  public static final String KAFKA_MONITOR_REQUIRED_ACKS = "kafka.monitor.required.acks";
  public static final String KAFKA_MONITOR_AUTO_COMMIT_INTERVAL =
      "kafka.monitor.auto.commit.interval";
  public static final String KAFKA_MONITOR_ZOOKEEPER_SERVERS = "kafka.monitor.zookeeper.servers";
  public static final String KAFKA_MONITOR_ZOOKEEPER_SESSION_TIMEOUT =
      "kafka.monitor.zookeeper.session.timeout";
  public static final String KAFKA_MONITOR_ZOOKEEPER_CONNECTION_TIMEOUT =
      "kafka.monitor.zookeeper.connection.timeout";
  public static final String KAFKA_MONITOR_ZOOKEEPER_SYNC_TIMEOUT =
