...
public interface MetaStore {
  ...
  boolean changeSchemasToUsed(Schema schema, String topologyId) throws MetaStoreException;

  boolean changeSchemasToFree(Schema schema, String topologyId) throws MetaStoreException;
  ...
  void deleteTopology(GungnirTopology topology) throws MetaStoreException;
