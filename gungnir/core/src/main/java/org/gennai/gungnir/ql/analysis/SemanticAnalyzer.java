...
public class SemanticAnalyzer {
  ...
  public SemanticAnalyzer() throws SemanticAnalyzeException {
  ...
  public void analyze(ASTNode node) throws SemanticAnalyzeException {
    ...
    switch (node.getType()) {
      ...
      case TOK_DROP_USER:
        ...
        break;
      case TOK_SUBMIT_TOPOLOGY:
        task = analyzeByAnalyzer(node);
        break;
      case TOK_DESC_TOPOLOGY:
        task = analyzeByAnalyzer(node);
        break;
      ...
      case TOK_START_TOPOLOGY:
        ...
        task = new StartTopologyTask(topologyName, statement.getOwner());
        break;
      case TOK_DROP_TOPOLOGY:
        topologyName = analyzeByAnalyzer(node.getChild(0));
        task = new DropTopologyTask(topologyName, statement.getOwner());
        break;
